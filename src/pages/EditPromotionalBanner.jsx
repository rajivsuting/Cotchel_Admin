...
const EditPromotionalBanner = () => {
    ...
    const fetchBanner = async () => {
      try {
        const response = await axios.get(
          `${API_BASE_URL}/promotional-banners/${id}`
        );
        ...
        const errorMessage =
          err.response?.data?.message || "Failed to fetch promotional banner";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`${API_BASE_URL}/promotional-banners/${id}`, formData);
      ...
      const errorMessage =
        err.response?.data?.message || "Failed to update promotional banner";
      setError(errorMessage);
      toast.error(errorMessage, {
        position: "top-right",
        autoClose: 5000,
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0c0b45] focus:border-transparent"
                  placeholder="Enter promotional banner position"
                />
              </div>
            </div>
            ...
            <div className="flex justify-end">
              ...
              >
                {loading ? "Updating..." : "Update Promotional Banner"}
              </button>
            </div>
          </form>
        </div>
