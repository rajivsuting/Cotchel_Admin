...
const AddPromotionalBanner = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API_BASE_URL}/promotional-banners`, formData);
      ...
      setError(
        err.response?.data?.message || "Failed to create promotional banner"
      );
      toast.error(
        err.response?.data?.message || "Failed to create promotional banner",
        {
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end">
              ...
              >
                {loading ? "Creating..." : "Create Promotional Banner"}
              </button>
            </div>
          </form>
        </div>
